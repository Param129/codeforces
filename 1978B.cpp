...
void dummyFunction1() {
    ...
    // cout << "Dummy Function 1" << endl;
}

void dummyFunction2() {
    // This is a dummy function
    // cout << "Dummy Function 2" << endl;
}

void dummyFunction3() {
    // This is a dummy function
    // cout << "Dummy Function 3" << endl;
    // return 2+8;
}

void dummyFunction4() {
    // This is a dummy function
    // cout << "Dummy Function 4" << endl;
    // return 2-8;
}

void dummyFunction5() {
    // This is a dummy function
    // cout << "Dummy Function 5" << endl;
}

long long calculate_profit(long long petunia, long long rose, long long daisy, long long lily) {
    return petunia * lily - (petunia * (petunia - 1)) / 2 + (rose - petunia) * daisy;
}
...
int main() {
    ...
    cin >> tulip;
    while (tulip--) {
        long long rose, daisy, lily;
        cin >> rose >> daisy >> lily;
        long long left = 0, right = min(rose, lily);
        long long sunflower_profit = 0;
...
*/
        while (left <= right) {
            ...
            long long profit1 = calculate_profit(mid1, rose, daisy, lily);
            long long profit2 = calculate_profit(mid2, rose, daisy, lily);
            ...
            /*
                           ...
                           jKWE#######L####WWLEW##E#KWWEfft,tLEDE,GW###############################WKWK#W##WE###KKK
                                  ...
                                  GLKWE#WE#WKjfLjtt,fDKWG##WWjKKWWWKWWKKKKEEDEEDKKKWKKKEKEEKEEEEEDE#WWWWWKE#KW#W#EDEEDDEELGE
*/
            sunflower_profit = max(sunflower_profit, max(profit1, profit2));
